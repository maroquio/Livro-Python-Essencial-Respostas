...
Com o ambiente virtual ativado, use o comando `deactivate` para desativar o ambiente virtual "pratica\_venv"\ e, em seguida, tente importar a biblioteca `requests` novamente. O que acontece?
